...
def _certificate_reminder_body(subject_type: str, user) -> str:
    ...
    return (
        f"Hi {name},\n\n"
        f"Thanks for registering as a {role} on Aqua Breeder. We noticed you haven't uploaded a "
        ...
        "credential — in your Aqua Breeder account settings so you can unlock and explore the full "
        "features of the app.\n\n"
